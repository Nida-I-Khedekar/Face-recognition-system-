...
class Train:
    def __init__(self,root):
        ...
        img_top=img_top.resize((1366,325),Image.Resampling.LANCZOS)
    ...
    # button
        ...
        img_bottom=img_bottom.resize((1366,250),Image.Resampling.LANCZOS)
        self.photoimg_bottom=ImageTk.PhotoImage(img_bottom)

        f_lbl=Label(self.root,image=self.photoimg_bottom)
        f_lbl.place(x=0,y=440,width=1366,height=250)
