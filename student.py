...
# Third Image
        ...
        f_lbl.place(x=900,y=0,width=550,height=130)

# bg img
        img3=Image.open(r"college_images\wp2551980.jpg")
        img3=img3.resize((1366,766),Image.Resampling.LANCZOS)
        self.photoimg3=ImageTk.PhotoImage(img3)

        bg_img=Label(self.root,image=self.photoimg3)
        bg_img.place(x=0,y=130,width=1366,height=766)

        title_lbl=Label(bg_img,text="STUDENT MANAGEMENT SYSTEM",font=("times new roman",30,"bold"),bg="white",fg="darkgreen")
        title_lbl.place(x=0,y=0,width=1366,height=45)

        main_frame=Frame(bg_img,bd=2,bg="white")
        main_frame.place(x=0,y=50,width=1366,height=540)

# left label frame
        Left_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Details",font=("times new roman",12,"bold"))
        Left_frame.place(x=5,y=2,width=705,height=500)
...
# Current Course
        ...
        Current_Course_frame.place(x=5,y=105,width=690,height=100)
        ...
        dep_combo["values"]=("Select Department","Computer Science","IT","Bsc","BMS")
        dep_combo.current(0)
        ...
        class_Student_frame.place(x=5,y=205,width=690,height=270)   
        ...
        # radio button
        self.var_radio1=StringVar()
        radionbtn1=ttk.Radiobutton(class_Student_frame,variable=self.var_radio1,text="Take Sample Photo",value="Yes")
        ...
        btn_frame.place(x=0,y=180,width=680,height=30)
        ...
        btn_frame1.place(x=0,y=210,width=680,height=30)
        ...
        update_photo_btn=Button(btn_frame1,text="Update Photo Sample",command=self.update_data,width=33,font=("times new roman",13,"bold"),bg="blue",fg="white")
        update_photo_btn.grid(row=0,column=1)


        # right label frame
        Right_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Details",font=("times new roman",12,"bold"))
        Right_frame.place(x=715,y=2,width=630,height=500)

        img_right=Image.open(r"college_images\gettyimages-1022573162.jpg")
        img_right=img_right.resize((610,100),Image.Resampling.LANCZOS)
        self.photoimg_right=ImageTk.PhotoImage(img_right)

        f_lbl=Label(Right_frame,image=self.photoimg_right)
        f_lbl.place(x=5,y=0,width=610,height=100)

        # xxxxxxxxxx  Search System  xxxxxxxxxx
        Search_frame=LabelFrame(Right_frame,bd=2,bg="white",relief=RIDGE,text="Search System",font=("times new roman",11,"bold"))
        Search_frame.place(x=5,y=105,width=610,height=70)
        ...
        search_combo=ttk.Combobox(Search_frame,textvariable=self.var_com_search,font=("times new roman",10,"bold"),state="readonly",width=15)
        ...
        search_btn=Button(Search_frame,command=self.search_data,text="Search",width=11,font=("times new roman",10,"bold"),bg="blue",fg="white")
        search_btn.grid(row=0,column=3,padx=8)

        showAll_btn=Button(Search_frame,command=self.fetch_data,text="Show All",width=11,font=("times new roman",10,"bold"),bg="blue",fg="white")
        showAll_btn.grid(row=0,column=4,padx=4)
        
        # table frame
        table_frame=Frame(Right_frame,bd=2,bg="white",relief=RIDGE)
        table_frame.place(x=5,y=180,width=610,height=290)

        scroll_x=ttk.Scrollbar(table_frame,orient=HORIZONTAL)
        scroll_y=ttk.Scrollbar(table_frame,orient=VERTICAL)

        self.student_table=ttk.Treeview(table_frame,column=("dep","course","year","sem","id","name","roll","div","dob","gender","email","phone","address","teacher","photo"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
        ...
        self.student_table.heading("roll",text="Class Division")
        self.student_table.heading("div",text="Roll No")
        self.student_table.heading("dob",text="Gender")
        self.student_table.heading("gender",text="Dob")
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.va_std_id.get()=="" or self.va_std_id.get()=="":
                ...
                try:
                        ...
                        self.fetch_data()
                        conn.close()
                        messagebox.showinfo("Success","Student Details had been added Successfully",parent=self.root)
    ...
    def generate_dataset(self):
        if self.var_dep.get()=="Select Department" or self.va_std_id.get()=="" or self.va_std_id.get()=="":
                ...
                try:
                    ...
                    face_classifier=cv2.CascadeClassifier("C:\\Users\\DELL\\AppData\\Local\\Programs\\Python\\Python313\\Lib\\site-packages\\cv2\\data\\haarcascade_frontalface_default.xml")
                    ...
                    while True:
                        ...
                        if face_cropped(my_frame) is not None:
                            ...
                            cv2.putText(face,str(img_id),(50,50),cv2.FONT_HERSHEY_COMPLEX,2,(0,255,00),2)
